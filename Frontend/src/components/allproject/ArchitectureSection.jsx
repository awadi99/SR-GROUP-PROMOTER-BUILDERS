    ...
    return (
        <div className="grid grid-cols-1 xl:grid-cols-[1fr_400px] gap-4 sm:gap-6">
            ...
            <div className="bg-[#121212] rounded-[24px] md:rounded-[36px] border border-[#A68966]/20 p-5 sm:p-8 md:p-10">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
                    <div className="rounded-3xl overflow-hidden h-[250px] sm:h-[420px]">
                        <motion.img src={project.gallery[0]} className="w-full h-full object-cover" whileHover={{ scale: 1.03 }} transition={{ duration: 0.6 }} />
                    </div>
                    <div className="grid grid-cols-2 sm:grid-cols-1 gap-4">
                        <div className="rounded-3xl overflow-hidden h-[150px] sm:h-[202px]">
                            <motion.img src={project.gallery[1]} className="w-full h-full object-cover" whileHover={{ scale: 1.03 }} transition={{ duration: 0.6 }} />
                        </div>
                        <div className="rounded-3xl overflow-hidden h-[150px] sm:h-[202px]">
                            <motion.img src={project.gallery[2]} className="w-full h-full object-cover" whileHover={{ scale: 1.03 }} transition={{ duration: 0.6 }} />
                        </div>
                    </div>
                </div>
            ...
            <div className="bg-[#121212] rounded-[40px] border border-[#A68966]/20 p-10 md:p-12 h-full ">
                ...
                {/* Rows - Distributed with more space */}
