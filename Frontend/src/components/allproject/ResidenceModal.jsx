        ...
        <AnimatePresence>
            {isOpen && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-2 sm:p-4">
                    ...
                    {/* Modal Card - Responsive container */}
                    <motion.div 
                        ...
                        <div className="overflow-y-auto p-4 sm:p-8">
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
                                ...
                                <div className="flex flex-col justify-start lg:justify-center">
                                    <h3 className="text-xl sm:text-3xl font-medium text-white mb-4 sm:mb-6">{unit.type}</h3>
                                    <div className="space-y-3 sm:space-y-6">
                                        <div className="flex justify-between border-b border-[#A68966]/10 pb-3">
                                            ...
                                            <span className="text-white font-medium text-sm sm:text-base">{unit.area}</span>
                                        </div>
                                        <div className="flex justify-between border-b border-[#A68966]/10 pb-3">
                                            <span className="text-gray-400 text-xs sm:text-sm">Price</span>
                                            <span className="text-[#A68966] font-bold text-lg sm:text-xl">{unit.price}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
