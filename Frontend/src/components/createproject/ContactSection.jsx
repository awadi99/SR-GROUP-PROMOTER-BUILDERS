    ...
    useEffect(() => {
        ...
        if (sections?.contact) {
            ...
            reset({
                ...
                salesManagerName:
                    sections.contact.salesManagerName || '',
        ...
        >
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-6">
                ...
                <Button
                    type="submit"
                    disabled={isCreating}
                    className="w-full sm:w-auto px-10 py-3 bg-transparent border border-[#B08B57] text-[#B08B57] hover:bg-[#B08B57] hover:text-black transition-all uppercase tracking-[0.2em] text-[10px] disabled:opacity-50"
                >
                    {isCreating
                        ? 'Finalizing...'
                        : 'Finalize Project'}
